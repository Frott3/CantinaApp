    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        salvar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(SugarORMActivity.this, p.getNome() + " cadastrado!", Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(SugarORMActivity.this, "Preencha todos os campos", Toast.LENGTH_SHORT).show();
        ...
        listarProdutos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Chama a outra tela
                startActivity( new Intent(SugarORMActivity.this, ProdListActivity.class) );
